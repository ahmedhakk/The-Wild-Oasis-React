...
function CreateCabinForm({ cabinToEdit = {}, onCloseModal }) {
  ...
  const isEditSession = Boolean(editId); // editId have a value => true else false
  ...
  const submitHandler = (data) => {
    ...
    if (isEditSession) {
      editCabin(
        ...
        {
          // we can access the onSuccess after editting the cabin
          onSuccess: () => {
            reset();
            onCloseModal?.();
          },
      ...
      createCabin(
        { ...data, image },
        {
          onSuccess: () => {
            // onSuccess: (data) => {
            // console.log(data); // give you the returned data
            reset();
            onCloseModal?.();
          },
        }
  ...
  return (
    ...
    <Form
      onSubmit={handleSubmit(submitHandler, onInvalidHandler)}
